...
<div id="preloading">
<img src="publicAssets/images/traffic-thumb.png" alt="">
</div>
       ...
       <div class="col-12">
           <div class="offcanvas_menu_wrapper">
               ...
               <div class="offcanvas-brand text-center mb-40">
                   <img src="publicAssets/images/logo.png" alt="">
               </div>
       ...
       <div class="row align-items-center">
                                   ...
                                   <ul class="mega-menu-ul-block">
                                       ...
                                       <li class="recent-right-text"> 
                                           <div class="mega-recent-post-text">
                                               <a href="#"><img src="publicAssets/images/blog/3.jpg" alt=""></a>
                                       ...
                                       <li class="recent-right-text "> 
                                           <div class="mega-recent-post-text">
                                               <a href="#"><img src="publicAssets/images/blog/1.jpg" alt=""></a>
                                               <div class="mega-recent-right-txt">
                                       ...
                                       <li class="recent-right-text "> 
                                           <div class="mega-recent-post-text">
                                               <a href="#"><img src="publicAssets/images/blog/2.jpg" alt=""></a>
                                               <div class="mega-recent-right-txt">
                                                   <a href="#"><h5> Permalink to A companion for extra sleeping </h5></a>
                                               <ul class="mega-menu-ul-block mega-menu-ul-block-lst">
                                                   <li> July 23, 2016 </li>
           ...
           <div class="col-lg-4  col-md-7 col-sm-6 col-6 order-2 order-sm-3">
            <div class="appie-btn-box text-right">
                ...
                <a class="main-btn ml-30" href="#">Register</a>
