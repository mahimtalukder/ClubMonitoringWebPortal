...
const DirectorViewProfile = (props) => {
                                ...
                                <div class="d-flex justify-content-center p-3 rounded-bottom">
                                    <div class="d-flex align-items-center m-0 p-0">
                                        ...
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" href="{{route('directorEditProfile')}}">Edit Profile</a>
                                            </li>
                                        </ul>
                        ...
                        <div class="card rounded">
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    ...
                                    <p class="text-muted">{$director.organisation}</p>
                                </div>
                                <div class="mt-3">
...
export default DirectorViewProfile;