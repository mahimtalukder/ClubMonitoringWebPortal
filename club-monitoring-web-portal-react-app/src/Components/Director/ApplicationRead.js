                                ...
                                <div className="row">
                                        ...
                                        <div className="d-flex align-items-center justify-content-between p-3 border-bottom tx-16">
                                            <div className="d-flex align-items-center">
                                                ...
                                                {application['is_approved'] === "pending" &&
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-clock text-muted icon-lg me-2"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
                                                }

                                                {<span>{application.subject}</span>}
                                            </div>
                                            <div>
                                                <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-printer text-muted icon-lg me-2" data-bs-toggle="tooltip" title="" data-bs-original-title="Print" aria-label="Print" aria-describedby="tooltip125286"><polyline points="6 9 6 2 18 2 18 9"></polyline><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"></path><rect x="6" y="14" width="12" height="8"></rect></svg></a>
                                            </div>
                                        </div>
                                        {/* @if ($errors->any())
                                    ...
                                    @endif */}
                                        <div className="d-flex align-items-center justify-content-between flex-wrap px-3 py-2 border-bottom">
                                            <div className="d-flex align-items-center">
                                                <div className="d-flex align-items-center">
                                                    <a href="#" className="text-muted">{club.name}</a>
                                                    <span className="mx-2 text-muted">to</span>
                                                    <a href="#" className="text-body me-2">{application.sent_to}</a>
                                                </div>
                                            </div>
                                            <div className="tx-13 text-muted mt-2 mt-sm-0">{new Date(application.created_at).toDateString()}</div>
                                        </div>
                                        <div className="p-4">
                                            {application.description}
                                        </div>
                                        <div className="p-4 border-bottom" >
                                            <div className="mb-3">Requested Date: {application.request_date}</div>
                                            {requested_components.length != 0 &&
                                                <div>
                                                    <div className="mb-3">Requested Components</div>
                                        ...
                                        {application.is_approved == "approved" &&
                                            <div className="p-3 bg-body">
                                                <div className="mb-3">Approved Date: {application.approve_date}</div>
                                        ...
                                        {application.is_approved == "rejected" &&
                                            <div className="p-3 bg-warning">
                                                <div className="mb-3"><strong>Application Rejected</strong></div>
                                        ...
                                        {application.is_approved == "pending" &&
                                            <form className="forms-sample" action="{{route('directorApplicationUpdateSubmitted')}}" method="post">
                                                <div className="p-3 bg-body">
                                                    <div className="mb-3"><strong>Application Approval Section</strong></div>
                                                    <input type="hidden" name='application_id' value={application.application_id} />
                                                    <div className="date">
                                                        <div className="row mb-3">
                                                            <label className="col-md-2 col-form-label">Approve Date</label>
                                                            <div className="col-md-10">
                                                                <div className="col-md-10">
                                                                    <div className="input-group date datepicker">
                                                                        <Form.Control type="date" className="form-control" name="date" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div className="mb-3 table-responsive">
                                                                <table className="table">
                                                                    ...
                                                                    <tbody id="component_body">
                                                                        {
                                                                            requested_components.map((requested_component, index) => (
                                                                                <ApplicationApproveComponetList id={requested_component.id} name={requested_component.name} i={index} ></ApplicationApproveComponetList>
                                                                            ))
                                                                        }
                                                                        <input type="hidden" name='total_component' value={requested_components.length}/>
                                                    ...
                                                    <div>
                                                        <div className="col-md-12">
                                                            <button className="btn btn-primary me-1 mb-1" type="submit"> Approve</button>
                                                            <a className="btn btn-danger me-1 mb-1" onclick="reject_full_application('{{$application_info->application_id}}')">Reject Application</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
