                ...
                <li class="nav-item active">
                    ...
                    <div class="collapse show" id="email">
                        <ul class="nav sub-menu">
                            <li class="nav-item">
                                <a href="https://www.nobleui.com/laravel/template/demo1/email/inbox" class="nav-link ">Application List</a>
                            </li>
                            <li class="nav-item">
                                <a href="https://www.nobleui.com/laravel/template/demo1/email/compose" class="nav-link active">Approved</a>
                            </li>
                            <li class="nav-item">
                                <a href="https://www.nobleui.com/laravel/template/demo1/email/compose" class="nav-link active">Approved</a>
                            </li>
