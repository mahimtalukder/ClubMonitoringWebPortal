                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{route('directorCreateClubSubmitted')}}"  novalidate="novalidate">
                                {{ csrf_field() }}

                                <div class="mb-3">
                                    <label for="name" class="form-label">Name</label>
                                    <input id="name" class="form-control @error('name'){{"is-invalid"}}@enderror" name="name" type="text" placeholder="Club Name">
