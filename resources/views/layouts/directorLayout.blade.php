...
<head>
    ...
    <meta name="keywords"
        content="nobleui, bootstrap, bootstrap 5, bootstrap5, director, dashboard, template, responsive, css, sass, html, theme, front-end, ui kit, web">
    ...
    <link rel="stylesheet"
        href="{{ asset('../assets/vendors/tempusdominus-bootstrap-4/tempusdominus-bootstrap-4.min.css') }}">
...
<body>
    <div class="main-wrapper">
        ...
        @include('inc.directorSideNav')

        <div class="page-wrapper">

            @include('inc.directorTopNav')
