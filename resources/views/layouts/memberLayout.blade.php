...
<head>
  ...
  <meta name="description" content="Responsive HTML member Dashboard Template based on Bootstrap 5">
	<meta name="author" content="NobleUI">
	<meta name="keywords" content="nobleui, bootstrap, bootstrap 5, bootstrap5, member, dashboard, template, responsive, css, sass, html, theme, front-end, ui kit, web">
...
<body>
    ...
    @include('inc.memberSideNav')
	
		<div class="page-wrapper">
					
      @include('inc.memberTopNav')
