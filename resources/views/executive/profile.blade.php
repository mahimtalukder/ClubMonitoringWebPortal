                    ...
                    <div class="d-flex justify-content-center p-3 rounded-bottom">
                        <div class="d-flex align-items-center m-0 p-0">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('executiveEditProfile')}}">Edit Profile</a>
                                </li>
                            </ul>
            ...
            <div class="card rounded">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <p class="text-muted">{{$executive->designation}}</p>
                    </div>
                    <div class="mt-3">
                        <label class="tx-11 fw-bolder mb-0 text-uppercase">Organisation:</label>
                        <p class="text-muted">{{$executive->organisation}}</p>
                    </div>
                    <div class="mt-3">
